...
func SeguirUsuario(w http.ResponseWriter, r *http.Request) { //essa funcao permite que um usuário siga outro
...
func PararDeSeguirUsuario(w http.ResponseWriter, r *http.Request) { // essa funcao permite que um usuário pare de seguir o outro
	seguidorID, erro := autenticacao.ExtrairUsuarioID(r)
	if erro != nil {
		respostas.Erro(w, http.StatusUnauthorized, erro)
		return 
...
func BuscarSeguidores(w http.ResponseWriter, r *http.Request) { // essa função traz todos os eguidores de um usuario
	parametros := mux.Vars(r)
	usuarioID, erro := strconv.ParseUint(parametros["usuarioId"], 10, 64)
	if erro != nil {
		respostas.Erro(w, http.StatusBadRequest, erro)
...
func BuscarSeguindo(w http.ResponseWriter, r *http.Request) { // essa função traz quem o usuário está seguindo
	parametros := mux.Vars(r)
	usuarioID, erro := strconv.ParseUint(parametros["usuarioId"], 10, 64)
	if erro != nil {
		respostas.Erro(w, http.StatusBadRequest, erro)
...
func AtualizarSenha(w http.ResponseWriter, r *http.Request) {// essa função permite que o usuário possa trocar a senha
	usuarioIDNoToken, erro := autenticacao.ExtrairUsuarioID(r)
	if erro != nil {
		respostas.Erro(w, http.StatusUnauthorized, erro)
		return
