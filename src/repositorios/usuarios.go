...
func (repositorio Usuarios) BuscarPorEmail(email string) (modelos.Usuario, error) { // essa função busca um usuario por email e retorna seu id e senha com hash
...
func (repositorio Usuarios) Seguir(usuarioID, seguidorID uint64) error { // essa função permite que um usuário siga outro
...
func (repositorio Usuarios) PararDeSeguir(usuarioID, seguidorID uint64) error { // essa função permite que um usuário deixe de seguir po outro
...
func (repositorio Usuarios) BuscarSeguidores(usuarioID uint64) ([]modelos.Usuario, error) { // essa função busca todos os seguiroes de um usuário
	linhas, erro := repositorio.db.Query(
...
func (repositorio Usuarios) BuscarSeguindo(usuarioID uint64) ([]modelos.Usuario, error) { // essa função traz quem o usuário está seguindo
	linhas, erro := repositorio.db.Query(`
